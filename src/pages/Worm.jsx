             ...
             {openModal === "nine" && (
              <>
               <h3 className="t">(2025-2023)<br></br> חרבות ברזל</h3>
                <p className="text-modal">
             גדוד 46 נלחם במשך כשנתיים בגזרת עזה, מקרבות שבעה באוקטובר ועד להסכם הפסקת האש שהוביל להחזרת החטופים. הגדוד החל את הלחימה תחת צק״ח 401 והשתתף בקרבות ההבקעה בצפון הרצועה, שהחלו לאורך ציר החוף ועד לעומק של 8 ק"מ דרומית לקו הגבול, והמשיכו ברצף מבצעים בשכונת ג'באליה ודארג' תופאח. לאחר מכן פעל הגדוד תחת צק״ח 933 בסדרת מבצעים בזייתון, שיח' רדואן ובית חאנון. בדרום הרצועה השתתף הגדוד במבצע לכיבוש רפיח ולהשתלטות על ציר פילדלפי ולקח חלק קריטי באיתור ובחילוץ של חטופים אשר נרצחו בשבי.
                </p>
              </>
            )}
