...
const resetFont = () => {
  ...
  <button onClick={resetFont}>🔄</button>
                ...
                <p className="text-box" style={{ fontSize }}>
                  ...
                  בבוקר יום שישי ה־11 באוגוסט הועבר הגדוד מפיקוד חטיבת הנח”ל לחטיבה 401 ושולב בנוהלי הקרב למשימה החטיבתית לפרוץ את הסלוקי ולכבוש שטחים שממערב לו. הגדוד הכניס ארבעה טנקים לחטיבת חי”ר מילואים שמשימתה הייתה לשמר את השליטה על השטח שעד הסלוקי כדי לאפשר צירים פתוחים. למחרת בשבת, הוטלה על כוח מגדוד “של”ח” משימה לחלץ טנק שנפגע מאזור כסיף. במהלך ניסיון לחבור לחילוץ, נפגע טנק מפגיעת טיל וארבעת אנשי הצוות נהרגו: מפקד הכוח, סרן בניה ריין, סמל אורי גרוסמן, סמ”ר אדם גורן וסמ”ר אלכס בונימוביץ’.

                  הסכם הפסקת האש הושג בעוד הגדוד שוהה בוואדי סלוקי, מוכן לחצות את הוואדי מערבה להמשך המשימות. בקרבות השתתף הגדוד במבצעים ובמשימות מורכבים מאוד, במהלכם הרג ופגע במחבלים רבים. אחרון הטנקים של גדוד “של”ח” הגיע לשטח מדינת ישראל ביום שלישי, 15 באוגוסט 2006 בשעה 10:30.
